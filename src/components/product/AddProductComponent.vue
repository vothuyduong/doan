                ...
                <form @submit.prevent="save">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" aria-label="Default select example" v-model="itemProduct.idCategory">
                            ...
                            <option v-for="(cat, index) in categorys" :key="index" :value="cat.idCategory">{{
                                cat.nameCategory }}</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-3" v-if="this.base64 !== ''">
                        <img class="imgProductDetail" :src="base64" alt="123image" />
                    </div>
    ...
    methods: {
        ...
        onChangeFileUpload(e) {
            ...
            theReader.onloadend = async () => {
                this.base64 = await theReader.result;
            };
