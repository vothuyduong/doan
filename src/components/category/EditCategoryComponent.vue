            ...
            <div class="form-add bg-white p-4 shadow rounded">
                <form @submit.prevent="save()">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" v-model="cate.nameCategory">
                    </div>
...
export default {
    ...
    methods: {
        async defaultData() {
            ...
            let res = await category.getDetail({"id": idd});
            this.cate.idCategory = res.data.idCategory;
            this.nameDefault = res.data.nameCategory;
            this.cate.nameCategory = res.data.nameCategory;
        },
        async save() {
            ...
            if (response.status === 200) {
                ...
                if (response.message === 'name.category.empty') {
                    this.cate.nameCategory = this.nameDefault;
                    this.sex = '';
